...
export const MainContent = ({ content, meta, params }) => {
  return (
    <>
      {
        content ?
          <>
            < article className='prose prose-invert prose-headings:text-[#e5c07b] prose-a:text-[#61afef] max-w-none' >
              <h1 className='text-3xl font-bold text-[#e5c07b] mb-4'>{meta.title}</h1>
            ...
            <FeedBackCard category={params.category} name={params.name} />
          </>
          :
