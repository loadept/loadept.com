...
func TestServeStatic(t *testing.T) {
	...
	t.Run("Valid File", func(t *testing.T) {
		req := httptest.NewRequest("GET", "/static/testfile.txt", nil)
		rr := httptest.NewRecorder()

		handler := api.ServeStatic(tmpDir)
	...
	t.Run("Invalid method", func(t *testing.T) {
		req := httptest.NewRequest("POST", "/static/testfile.txt", nil)
		rr := httptest.NewRecorder()
	...
	t.Run("HEAD method", func(t *testing.T) {
		req := httptest.NewRequest("HEAD", "/static/testfile.txt", nil)
		rr := httptest.NewRecorder()
	...
	t.Run("Hidden file", func(t *testing.T) {
		req := httptest.NewRequest("GET", "/static/.hidden", nil)
		rr := httptest.NewRecorder()
