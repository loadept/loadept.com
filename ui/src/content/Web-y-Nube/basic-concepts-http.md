...
1. **Solicitud del cliente**:
  ...
  ![http-request](https://assets.loadept.com/p/http-request.svg)
...
1. **Respuesta del servidor**:
  ...
  ![processing](https://assets.loadept.com/p/processing.svg)
  ...
  Esta respuesta puede incluir el recurso deseado (como el **HTML** de una página web, una imagen, etc.). 
	...
	![http-response](https://assets.loadept.com/p/https-response.svg)
...
![http-content](https://assets.loadept.com/p/http-content.svg)
